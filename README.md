## rosidl_core (rolling) - 0.5.0-1

The packages in the `rosidl_core` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling rosidl_core` on `Tue, 05 May 2026 17:54:44 -0000`
...
## rosidl_core (rolling) - 0.4.3-1

The packages in the `rosidl_core` repository were released into the `rolling` distro by running `/usr/local/google/home/sloretz/projects/lyrical/env3/bin/bloom-release rosidl_core -r rolling -t rolling` on `Mon, 20 Apr 2026 22:51:43 -0000`
...
## rosidl_core (rolling) - 0.4.2-1

The packages in the `rosidl_core` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling rosidl_core` on `Thu, 09 Apr 2026 10:33:09 -0000`
...
## rosidl_core (rolling) - 0.4.1-1

The packages in the `rosidl_core` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling rosidl_core` on `Tue, 07 Oct 2025 09:02:31 -0000`
