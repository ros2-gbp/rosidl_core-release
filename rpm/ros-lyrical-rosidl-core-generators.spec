...
%global pkg_name rosidl_core_generators
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-rosidl-core-generators
Version:        0.4.3
Release:        3%{?dist}
...
%changelog
* Wed Apr 29 2026 Shane Loretz <sloretz@openrobotics.org> - 0.4.3-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Shane Loretz <sloretz@openrobotics.org> - 0.4.3-2
- Autogenerated by Bloom
